...
class TechincalInterview {
    public static void mine_block(Transaction[] mempool) {
        ...
        PriorityQueue<Transaction> maxHeap = new PriorityQueue<>(Comparator.comparingDouble((Transaction t) -> t.rank).reversed());
    ...
    public static void mine_block2(Transaction[] mempool) {
        ...
        Arrays.sort(mempool, Comparator.comparingDouble((Transaction t) -> t.rank).reversed());
